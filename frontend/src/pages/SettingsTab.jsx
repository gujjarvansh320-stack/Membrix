...
//   const currentTerms =
//     user?.termsAndConditions || user?.data?.termsAndConditions || "";
...
//     try {
//       const response = await api.put("/users/update-gym-profile", submitData, {
//   headers: {
...
//                   Changes will automatically update your dashboard sidebar and
//                   invoices.
//                 </p>
//               </div>
//             </div>
...
import CouponsManager from "./CouponsManager";
import { UploadCloud, CheckCircle } from "lucide-react";
import api from "../api/axios.js"; // Added missing api import
...
const SettingsTab = () => {
  ...
  const handleProfileSubmit = async (e) => {
    ...
    try {
      ...
      // Removed the incorrect !response.ok check here
