...
// import { UserPlus, CheckCircle, Edit2, Trash2, X } from "lucide-react";
...
//     try {
//       const gymId = getOwnerGymId();
//       await api.post('/auth/create-staff', { ...staffData, gymId, permissions });
...
//     e.preventDefault();
//     try {
//       await api.put(`/auth/staff/${editData._id}`, editData);
...
//                     <td className="py-3 px-4 font-semibold text-gray-800">{staff.name}</td>
...
//                 />
//               </div>
//               <div onClick={startCamera} className="flex-1 border-2 border-dashed border-gray-300 rounded-lg p-4 bg-gray-50 hover:bg-gray-100 transition cursor-pointer flex flex-col items-center justify-center">
